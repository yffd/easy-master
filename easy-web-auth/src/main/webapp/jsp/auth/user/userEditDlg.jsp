			...
			<fieldset>
				...
				<table>
					...
					<tr>
						...
						<th>状态</th>
						<td>
							<select name="userState" class="easyui-combobox" style="width:171px;" data-options="editable:false,required:true">
					...
					<tr>
						<th>密码</th>
						<td><input name="userPwd" class="easyui-textbox easyui-validatebox"/></td>
					</tr>
					<tr>
						<th>电话</th>
