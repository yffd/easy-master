...
import org.yffd.easy.common.ssm.web.filter.CaptchaFilter;
...
public class CaptchaValidateFilter extends AccessControlFilter {
	...
	protected boolean isAccessAllowed(ServletRequest request, ServletResponse response, Object mappedValue)
		...
		// 获取session中的验证码
		String captcha = (String) httpServletRequest.getSession().getAttribute(CaptchaFilter.CAPTCHA_SESSION_KEY);
