...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
	...
	<div data-options="region:'north',border:false" style="height:40px;background:#EEE;padding:10px;overflow:hidden;" href="admin/layout/north.jsp">
    </div>
    ...
    <div data-options="region:'south',border:false" style="height:25px;background:#EEE;padding:5px;" href="admin/layout/south.jsp">
    </div>
    
    
    <div data-options="region:'center',plain:true,title:'欢迎使用'" style="overflow: hidden;" href="admin/layout/center.jsp">
    </div>
