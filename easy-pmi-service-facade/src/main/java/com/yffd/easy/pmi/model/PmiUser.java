 ...
 * @see 	 
 */
public class PmiUser extends PersistModel {
	...
	private PmiOrganization organization;
	...
	public PmiOrganization getOrganization() {
		return organization;
	}
	public void setOrganization(PmiOrganization organization) {
