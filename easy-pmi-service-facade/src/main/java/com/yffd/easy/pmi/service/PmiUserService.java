 ...
 * @see 	 
 */
public interface PmiUserService {

	PageResult<PmiUser> findList(PmiUser user, PageParam pageParam);
	
	PmiUser findByCode(String userCode);
	
	void add(PmiUser user);
	
	void editByCode(PmiUser user);
