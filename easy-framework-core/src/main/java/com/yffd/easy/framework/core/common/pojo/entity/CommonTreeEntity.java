...
package com.yffd.easy.framework.core.common.pojo.entity;
 ...
 * @see
 */
public class CommonTreeEntity implements IPOJO, Serializable {
	...
	private List<CommonTreeEntity> children;
	...
	public List<CommonTreeEntity> getChildren() {
		return children;
	}
	public void setChildren(List<CommonTreeEntity> children) {
