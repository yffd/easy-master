 ...
 * @see 	 
 */
public class ServiceTestCodeGenerator extends CodeGenerator {
	private static final String FILE_SUFFIX = ".java";
	private static final String TEMPLATE_PATH = "com\\yffd\\easy\\framework\\support\\code\\template\\XxxServiceTest.template";
	
	public void writeAllToFile(String modelRootDirPath, String modelPackageName, Class<?> baseServiceTestClazz, String serviceTestPackageName, String author, String outRootDirPath, boolean covered) throws Exception {
			...
			for(File childFile : files) {
				if(childFile.isDirectory()) {
					...
					if(!skip) {
						...
						this.writeToFile(modelClazz, baseServiceTestClazz, serviceTestPackageName, author, outRootDirPath, covered);
					}
				}
			}
		}
	...
	public void writeToFile(Class<?> modelClazz, Class<?> baseServiceTestClazz, String serviceTestPackageName, String author, String outRootDirPath, boolean covered) {
		String content = this.makeContent(modelClazz, baseServiceTestClazz, serviceTestPackageName, author);
	...
	public void writeToConsole(Class<?> modelClazz, Class<?> baseServiceTestClazz, String serviceTestPackageName, String author) {
		String content = this.makeContent(modelClazz, baseServiceTestClazz, serviceTestPackageName, author);
		System.out.println(content);
	}
	
	protected String makeContent(Class<?> modelClazz, Class<?> baseServiceTestClazz, String serviceTestPackageName, String author) {
		...
		if(null!=baseServiceTestClazz) {
			content = content.replace("##import_test_base_service_full_name##", baseServiceTestClazz.getName());
			content = content.replace("##test_base_service_name##", "extends " + baseServiceTestClazz.getSimpleName() + " ");
		} else {
			content = content.replace("##import_test_base_service_full_name##", "");
...
//		generator.writeToFile(modelClazz, baseServiceTestClazz, serviceTestPackageName, author, outRootDirPath, covered);
	}
}
