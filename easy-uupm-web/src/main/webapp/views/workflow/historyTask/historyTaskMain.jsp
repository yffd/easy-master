...
<script type="text/javascript">
	...
	$(function() {
		$dg = $('#dg_id');
		$dg.datagrid({
		    url:'workflow/query/findHistoryTaskListPage',
		    width: 'auto',
...
// 	    	                 {field: 'wfDesc', title: '流程描述', width: 200, align: 'left'}  
	...
	// 查看候选人
	function findTaskCandidators() {
		var row = $dg.datagrid('getSelected');
		if(row) {
			parent.$.modalDialog.taskId=row.id;
			parent.$.modalDialog({
				title: "候选人信息",
				width: 600,
				height: $(this).height()-200,
				href: 'views/workflow/historyTask/historyCandidatorsDlg.jsp',
				buttons: [{
					text: '关闭',
					iconCls: 'icon-cancel',
					handler: function() {
	...
	function findVariables() {
		...
		if(row) {
			...
			parent.$.modalDialog({
				...
				width: 950,
				height: $(this).height()-200,
				href: 'views/workflow/historyTask/historyVariablesDlg.jsp',
				buttons: [{
					text: '关闭',
					iconCls: 'icon-cancel',
					handler: function() {
