			...
			<fieldset>
				<table class="edit-form-table">
					<tr>
						...
						<th>编号：</th>
						<td><input name="nodeCode" onblur="setValue(this)" class="easyui-textbox easyui-validatebox" required="required" placeholder="请输入编号"/></td>
					</tr>
					<tr>
						<th>父名称：</th>
