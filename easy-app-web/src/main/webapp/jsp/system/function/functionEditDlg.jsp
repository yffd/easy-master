		...
		<form id="form_id" method="post">
			<fieldset>
				...
				<table>
					<tr>
						<th>名称</th>
						<td><input name="funcName" class="easyui-textbox easyui-validatebox" required="required" placeholder="请输入名称" /></td>
						<th>编号</th>
						<td><input id="funcCode_id" name="funcCode" class="easyui-textbox easyui-validatebox" required="required"/></td>
					</tr>
					<tr>
						<th>父名称</th>
					...
					<tr>
						<th>类型</th>
						<td>
							<select name="type" class="easyui-combobox" style="width:171px;" data-options="editable:false,required:true">
						...
						<th>是否启用</th>
						<td>
							<select name="active" class="easyui-combobox" style="width:171px;" data-options="editable:false,required:true">
					...
					<tr>
						<th>排序编号</th>
						<td><input name="sort" class="easyui-textbox easyui-validatebox"/></td>
						<th>图标</th>
						<td><input id="iconCls_id" name="iconCls" class="easyui-textbox"/></td>
					</tr>
					<tr>
						<th>描述</th>
