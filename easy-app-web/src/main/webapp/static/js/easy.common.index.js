    ...
    commonindex.initLeftMenu = function(menuJson) {
		...
		if(menuJson && menuJson.length>0) {
			...
			if(first.children && first.children.length>0) {
				...
				var firstUrl = first.children[0].url;
        ...
        $.each(menuJson, function(i, n) {
            ...
            if(n.children && n.children.length>0) {
                $.each(n.children, function(j, o) {
                    menulist += '<li><div><a ref="'+o.id+'" href="javascript:void(0);" rel="' + o.url + '" ><span class="'+o.iconCls+'" >&nbsp;</span><span class="nav">' + o.text + '</span></a></div></li> ';
                })
            }
            menulist += '</ul>';
