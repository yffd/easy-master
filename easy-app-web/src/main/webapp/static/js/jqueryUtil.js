(function($)
{
	...
	var createGridHeaderContextMenu = function(e, field) {
		console.info(">>jqueryUtil>>>createGridHeaderContextMenu");
		e.preventDefault();
	...
	$.fn.panel.defaults.onBeforeDestroy = function() {
		console.info(">>jqueryUtil>>>onBeforeDestroy");
	...
	$.fn.treegrid.defaults.loadFilter = function(data, parentId) {
		console.info(">>jqueryUtil>>>$.fn.treegrid.defaults.loadFilter");
	...
	$.fn.tree.defaults.loadFilter = function(data, parent) {
		console.info(">>jqueryUtil>>>$.fn.tree.defaults.loadFilter");
	...
	$.fn.combotree.defaults.loadFilter = function(data, parent) {
		console.info(">>jqueryUtil>>>$.fn.combotree.defaults.loadFilter");
		var opt = $(this).data().tree.options;
		var idFiled, textFiled, parentField;
		if (opt.parentField) {
			idFiled = opt.idFiled || 'id';
	...
	$.extend($.fn.treegrid.defaults,{
		onLoadSuccess : function() {
			console.info(">>jqueryUtil>>>$.fn.treegrid.default>>onLoadSuccess");
			var target = $(this);
	...
	$.extend($.fn.treegrid.methods,{
		...
		cascadeCheck : function(target,param){
			console.info(">>jqueryUtil>>>$.fn.treegrid.methods>>cascadeCheck");
	...
	function selectParent(target,id,idField,status){
		console.info(">>jqueryUtil>>>selectParent");
	...
	function selectChildren(target,id,idField,deepCascade,status){
		console.info(">>jqueryUtil>>>selectChildren");
		//深度级联时先展开节点
