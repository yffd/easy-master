package com.yffd.easy.common.support.dao.impl;
...
public class BaseDaoImpl<T> extends EasyModelConverter implements IBaseDao<T> {
	 ...
	 * @param paramMap
	 * @return
	 * @see org.yffd.easy.common.ssm.dao.IBaseDao#selectPage(com.yffd.easy.common.core.page.PageParam, java.util.Map)
	 */
	@Override
	...
	public int insertBatch(List<T> list) {
        ...
        if (result <= 0) {
            throw EasyDaoException.DB_INSERT_RESULT_0(getStatement(SQL_INSERT_BATCH));
        }
        return result;
	}
	...
	public int updateBy(T model) {
        ...
        if (result <= 0) {
            throw EasyDaoException.DB_UPDATE_RESULT_0(getStatement(SQL_UPDATE_BY));
        }
        return result;
	}
	...
	public int updateByPK(T model) {
        ...
        if (result <= 0) {
            throw EasyDaoException.DB_UPDATE_RESULT_0(getStatement(SQL_UPDATE_BY_PK));
        }
        return result;
	}
	...
	public int deleteByPK(String primaryKey) {
		...
		if (result <= 0) {
            throw EasyDaoException.DB_DELETE_RESULT_0(getStatement(SQL_UPDATE_BY_PK));
        }
        return result;
	}
