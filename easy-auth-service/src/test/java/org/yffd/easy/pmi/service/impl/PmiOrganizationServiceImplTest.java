...
public class PmiOrganizationServiceImplTest extends SpringBaseTestCase {
	...
	@Autowired
	private AuthOrganizationService pmiOrganizationService;
	
	@Test
	public void findByParentCodeTest() {
		List<AuthOrganization> list = this.pmiOrganizationService.findByParentCode("1002");
		for(AuthOrganization entity:list) {
	...
	public void addTest() {
		for(int i=0;i<5;i++) {
			AuthOrganization entity = new AuthOrganization();
