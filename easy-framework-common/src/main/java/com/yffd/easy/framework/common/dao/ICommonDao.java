 ...
 * @see 	 
 */
public interface ICommonDao<E> extends ICommonBaseDao<E> {
	...
	List<E> findListByOrder(E entity, Map<String, Object> map, String[] orderPropertyNames, String[] orderByTypes);
	
	List<E> findListByOrder(E entity, String orderBy);
	
	List<E> findListByOrder(Map<String, Object> map, String orderBy);
	
	List<E> findAllByOrder(String orderBy);
	...
	PageResult<E> findPageByOrder(E entity, Map<String, Object> map, String[] orderPropertyNames, String[] orderByTypes, PageParam page);
	
	PageResult<E> findPageByOrder(E entity, String orderBy, PageParam page);
	
	PageResult<E> findPageByOrder(Map<String, Object> map, String orderBy, PageParam page);
