...
/**
 * @Description  mybatis dao常用操作类，以entity的完整类名作为mapper sql 的命名空间.
 ...
 * @see 	 
 */
public abstract class MybatisCommonBaseDaoImpl<E> extends MybatisCommonCustomDaoSupport implements ICommonBaseDao<E> {
	...
	public abstract Class<?> getBindEntityClass();

	@Override
	protected String getStatement(String sqlId) {
		return this.getBindEntityClass().getName() + sqlId;
	}
