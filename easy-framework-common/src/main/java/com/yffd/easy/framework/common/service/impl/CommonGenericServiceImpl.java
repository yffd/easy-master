 ...
 * @see 	 
 */
public abstract class CommonGenericServiceImpl<VO> extends CommonServiceSupport implements ICommonService<VO> {

	protected abstract <T> BakICommonExtDao<T> getBindDao();
