...
public class PageParam implements Serializable {
	...
	/** 开始页码为1*/
    public static final Long PAGE_NUM_START = 1L;
    /** 每页最小记录数(15) */
    public static final Long PAGE_LIMIT_MIN = 1L;
    /** 每页最大记录数(100) */
    public static final Long PAGE_LIMIT_MAX = 100L;
    
    private Long pageNum; 		// 当前页数
    private Long pageLimit; 	// 每页记录数
    private Long totalRecord; 	// 总记录数
    
//    private Long startIndex; 	// 每页开始行号
//    private Long endIndex; 	// 每页结束行号
//    private Long totalPage; 	// 总页数
    
    /** 是否进行自动count计算总条数，默认为自动计算：true:是，false:否 */
//    private boolean autoCount = true;
    
	public PageParam(Long pageNum, Long pageLimit) {
