...
<script type="text/javascript">
	...
	$(function() {
		...
		$dg.datagrid({
	        ...
	        columns: [[
						...
						{field: 'suspensionState', title: '是否挂起', width: parseInt($(this).width()*0.05), align: 'left',
							formatter: function(value, row) {
	...
	function loadResource(processDefinitionId, resourceType) {
		var url = "workflow/processDefinition/loadResource?processDefinitionId="+processDefinitionId+"&resourceType="+resourceType;
		window.open(url,"_blank");
	}
	
	function updateState(processDefinitionId, state) {
		var url = "workflow/processDefinition/update/"+state+"/"+processDefinitionId;
...
<body class="easyui-layout,fit:true">
	...
	<div data-options="region:'center',border:false" style="overflow:hidden;">
		<table id="dg_id" title="流程定义及部署管理"></table>
	</div>
