 ...
 * @see
 */
public class UupmReUserRoleDaoTest extends UupmBaseDaoTest {

	@Autowired
	private UupmUserRoleDao dao;

	@Override
	public Class<?> getModelClass() {
		return UupmUserRoleModel.class;
	}
	...
	public void selectPageTest() {
		...
		UupmUserRoleModel model = new UupmUserRoleModel();
		if(null!=model) {
			PageResult<UupmUserRoleModel> pageResult = (PageResult<UupmUserRoleModel>) this.dao.selectPage(model, pageParam);
			...
			Map<String, Object> paramMap = this.dao.model2map(model, null);
			PageResult<UupmUserRoleModel> pageResult2 = (PageResult<UupmUserRoleModel>) this.dao.selectPage(paramMap, pageParam);
	...
	public void selectListByTest() {
		...
		List<UupmUserRoleModel> resultList = (List<UupmUserRoleModel>) this.dao.selectListBy(model);
		Assert.assertNotNull(resultList);
		System.out.println(resultList.size());
		for(UupmUserRoleModel tmp : resultList) {
			System.out.println(tmp.getId());
		}
		
		Map<String, Object> paramMap = this.dao.model2map(model, null);
		List<UupmUserRoleModel> resultList2 = (List<UupmUserRoleModel>) this.dao.selectListBy(paramMap);
		Assert.assertNotNull(resultList2);
		System.out.println(resultList2.size());
		for(UupmUserRoleModel tmp : resultList2) {
			System.out.println(tmp.getId());
		}
	}
	...
	public void selectOneTest() {
		...
		UupmUserRoleModel result = this.dao.selectOne(model);
		System.out.println(result);
		
		Map<String, Object> paramMap = this.dao.model2map(model, null);
		UupmUserRoleModel result2 = this.dao.selectOne(paramMap);
		System.out.println(result2);
	}
	...
	public void selectByIdTest() {
		String id = "2001";
		UupmUserRoleModel result = this.dao.selectById(id);
	...
	public void selectListByIdsTest() {
		...
		List<UupmUserRoleModel> result = (List<UupmUserRoleModel>) this.dao.selectListByIds(list);
		Assert.assertNotNull(result);
		System.out.println(result.size());
		for(UupmUserRoleModel tmp : result) {
	...
	public void selectAllTest() {
		List<UupmUserRoleModel> result = (List<UupmUserRoleModel>) this.dao.selectAll();
		Assert.assertNotNull(result);
		System.out.println(result.size());
		for(UupmUserRoleModel tmp : result) {
			System.out.println(tmp);
	...
	public void insertOneTest() {
		UupmUserRoleModel model = (UupmUserRoleModel) this.getRandomModel();
	...
	public void insertBatchTest() {
		List<UupmUserRoleModel> models = (List<UupmUserRoleModel>) this.getRandomModelList();
		int result = this.dao.insertBatch(models);
		System.out.println(result);
		
		List<Map<String, Object>> list = new ArrayList<Map<String, Object>>();
		for(UupmUserRoleModel model : models) {
