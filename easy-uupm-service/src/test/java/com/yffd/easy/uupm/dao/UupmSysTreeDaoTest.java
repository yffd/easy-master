 ...
 * @see
 */
public class UupmSysTreeDaoTest extends UupmBaseDaoTest {

	@Autowired
	private UupmSysTreeDao dao;

	@Override
	public Class<?> getModelClass() {
		return UupmSysTreeModel.class;
	}
	...
	public void selectCountByTest() {
		UupmSysTreeModel model = new UupmSysTreeModel();
	...
	public void selectPageTest() {
		...
		UupmSysTreeModel model = new UupmSysTreeModel();
		if(null!=model) {
			PageResult<UupmSysTreeModel> pageResult = (PageResult<UupmSysTreeModel>) this.dao.selectPage(model, pageParam);
			...
			Map<String, Object> paramMap = this.dao.model2map(model, null);
			PageResult<UupmSysTreeModel> pageResult2 = (PageResult<UupmSysTreeModel>) this.dao.selectPage(paramMap, pageParam);
	...
	public void selectListByTest() {
		...
		List<UupmSysTreeModel> resultList = (List<UupmSysTreeModel>) this.dao.selectListBy(model);
		Assert.assertNotNull(resultList);
		System.out.println(resultList.size());
		for(UupmSysTreeModel tmp : resultList) {
			System.out.println(tmp.getId());
		}
		
		Map<String, Object> paramMap = this.dao.model2map(model, null);
		List<UupmSysTreeModel> resultList2 = (List<UupmSysTreeModel>) this.dao.selectListBy(paramMap);
		Assert.assertNotNull(resultList2);
		System.out.println(resultList2.size());
		for(UupmSysTreeModel tmp : resultList2) {
			System.out.println(tmp.getId());
		}
	}
	...
	public void selectOneTest() {
		...
		UupmSysTreeModel result = this.dao.selectOne(model);
		System.out.println(result);
		
		Map<String, Object> paramMap = this.dao.model2map(model, null);
		UupmSysTreeModel result2 = this.dao.selectOne(paramMap);
		System.out.println(result2);
	}
	...
	public void selectByIdTest() {
		String id = "2001";
		UupmSysTreeModel result = this.dao.selectById(id);
	...
	public void selectListByIdsTest() {
		...
		List<UupmSysTreeModel> result = (List<UupmSysTreeModel>) this.dao.selectListByIds(list);
		Assert.assertNotNull(result);
		System.out.println(result.size());
		for(UupmSysTreeModel tmp : result) {
	...
	public void selectAllTest() {
		List<UupmSysTreeModel> result = (List<UupmSysTreeModel>) this.dao.selectAll();
		Assert.assertNotNull(result);
		System.out.println(result.size());
		for(UupmSysTreeModel tmp : result) {
			System.out.println(tmp);
	...
	public void insertOneTest() {
		UupmSysTreeModel model = (UupmSysTreeModel) this.getRandomModel();
	...
	public void insertBatchTest() {
		List<UupmSysTreeModel> models = (List<UupmSysTreeModel>) this.getRandomModelList();
		int result = this.dao.insertBatch(models);
		System.out.println(result);
		
		List<Map<String, Object>> list = new ArrayList<Map<String, Object>>();
		for(UupmSysTreeModel model : models) {
