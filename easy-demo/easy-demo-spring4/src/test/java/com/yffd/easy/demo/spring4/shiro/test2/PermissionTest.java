package com.yffd.easy.demo.spring4.shiro.test2;
...
public class PermissionTest extends BaseTest {
    ...
    public void testIsPermitted() {
        login("classpath:shiro/test2/shiro-permission.ini", "zhang", "123");
        //判断拥有权限：user:create
    ...
    public void testWildcardPermission1() {
        login("classpath:shiro/test2/shiro-permission.ini", "li", "123");
