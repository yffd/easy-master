...
(
   ...
   DATA_CATEGORY        varchar(30) comment '数据类别:CAT_DICT、CAT_OA等',
   DATA_LABEL           varchar(30) comment '数据标签：BRANCH（分支）、LEAF（叶子）',
   DATA_SHOW_TYPE       varchar(30) comment '数据展示方式:TREE、FLAT',
