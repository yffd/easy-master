...
public class PmiResourceServiceImplTest extends SpringBaseTestCase {
	...
	public void findMenuTest() {
		List<PmiResource> list = this.pmiResourceService.findByParentCode("-1");
		System.out.println(list.size());
	}
	
	@Test
	public void addTest() {
		PmiResource model = new PmiResource();
		...
		PmiResource model1 = new PmiResource();
	...
	public void addMultiTest() {
		for(int i=0;i<5;i++) {
			...
			for(int j=0;j<5;j++) {
				PmiResource child = new PmiResource();
